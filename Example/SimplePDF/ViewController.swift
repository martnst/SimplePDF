...
class ViewController: UIViewController, UIDocumentInteractionControllerDelegate {
    ...
    private func addDocumentCover(pdf: SimplePDF) {
        ...
        pdf.add(attributedString: documentTitle)
    ...
    private func addHeadersFooters(_ pdf: SimplePDF) {
        ...
        let rightLogo = SimplePDF.HeaderFooterImage(type: .header, pageRange: NSMakeRange(1, Int.max),
                                                    imagePath: logoPath!, image:nil, imageHeight: CGFloat(35), alignment: .right)
        ...
        let footerImage = SimplePDF.HeaderFooterImage(type: .footer, pageRange: NSMakeRange(1, Int.max),
                                                      imagePath: logoPath!, image:nil, imageHeight: CGFloat(20), alignment: .right)
